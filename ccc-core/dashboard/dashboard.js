if(sessionStorage.getItem("ccc-enter-workspace")==="1"){document.documentElement.classList.add("workspace-arrival");sessionStorage.removeItem("ccc-enter-workspace");setTimeout(()=>document.documentElement.classList.remove("workspace-arrival"),1100);}
import { auth } from "../auth/firebase.js";
import { onAuthStateChanged } from "https://www.gstatic.com/firebasejs/12.1.0/firebase-auth.js";

onAuthStateChanged(auth,(user)=>{
  if(!user) window.location.href="../auth/index.html";
});
...
publishSelectedBtn?.addEventListener("click",()=>{
  ...
  window.location.href="../publish/index.html?v=2.8.3";
});
