# Lina Clean Core Architecture V0.2.7
...
När en funktion fungerat i legacy används den implementationen som förstahandsreferens och regressionstest innan ny lösning byggs. V0.2.7 återanvänder V0.58.8:s `v0512Refresh`-beteende.


## Auth/refresh invariant V0.2.7
...
V0.2.7: loginfältets autofill-skydd är portat från legacy V0.46.3. Browser reload tvingar ren login utan att röra localStorage.

## V0.2.7 – G2-modulgräns
