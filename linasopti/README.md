...
## V0.38.3 – Clean rebuild from V0.36.8

Detta paket är byggt om från **V0.36.8**, den sista kända fungerande basen före lösenkodsgaten.

Återlagt ovanpå V0.36.8:
- isolerad lösenkod `adam`, helt utanför appens huvud-JS
- fast Data/Test/Resultat-header
- dynamiska periodval: 1/3/5/10 år + de senaste 10 kalenderåren
- tydlig blå vald period med ✓
- start högst upp efter inloggning
