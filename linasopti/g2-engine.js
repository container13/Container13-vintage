(function(){
  ...
  function robustReport(){
    ...
    const L=['LINAS OPTI – G2 ROBUSTHETSANALYS','Clean Core: V0.2.11','Kandidat: '+r.candidateHash,'Handel: AVSTÄNGD','',
