(function(){
'use strict';
const API='https://linas-opti-api.mangaj73.workers.dev', KEY='lina_clean_evidence_queue_v1', RELEASE='V0.2.40';
...
window.LinaEvidence={stage,approve,approveAndSync,freezeEngine,syncApproved,items,sourceStatus,install};
})();
