...
- [ ] Live reproducerbarhetskörning mot legacy-resultat – kräver lyckad historisk Worker-data och görs efter användarens första V0.2.4-körning.

- [x] V0.2.4: ny start/inloggning ignorerar gammal hash och öppnar alltid Dashboard.
