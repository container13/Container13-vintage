...
- [ ] Live reproducerbarhetskörning mot legacy-resultat – kräver lyckad historisk Worker-data och görs efter användarens första V0.2.6-körning.

- [x] V0.2.6: ny start/inloggning ignorerar gammal hash och öppnar alltid Dashboard.
