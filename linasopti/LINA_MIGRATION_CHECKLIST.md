...
- [ ] Live reproducerbarhetskörning mot legacy-resultat – kräver lyckad historisk Worker-data och görs efter användarens första V0.2.5-körning.

- [x] V0.2.5: ny start/inloggning ignorerar gammal hash och öppnar alltid Dashboard.
