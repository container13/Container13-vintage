...
function render(root,ctx){
 ...
 root.querySelector('#g6Report')?.addEventListener('click',async()=>{const b=root.querySelector('#g6Report');b.disabled=true;b.textContent='Fryser…';const q=await window.LinaEvidence.freezeEngine(E,'G6');b.textContent=q.status==='FROZEN · GITHUB ✓'?'✓ FROZEN · GITHUB ✓':'✓ FROZEN · VÄNTAR PÅ SYNK'});root.querySelector('#g6Raw')?.addEventListener('click',()=>E.exportRaw());
