...
function mergeForwardState(local, incoming) {
  if (!local) return {...validateForwardPackage(incoming),release:"V0.2.32",exportedAt:new Date().toISOString()};
  ...
  return {schema:"LINA-FORWARD-SYNC-1",release:"V0.2.32",exportedAt:new Date().toISOString(),anchor:FORWARD_ANCHOR,tradeEnabled:false,g2,g3};
}
      ...
      return json(
        {
          ...
          version: "0.58.8 + forward-state-v0232",
          mode: "paper",
