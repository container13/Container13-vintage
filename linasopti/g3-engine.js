(function(){
'use strict';
const VERSION='0.2.11',KEY='lina_clean_swing_g3_walkforward_v0209';
...
function fresh(){return{schema:'LINA-SWING-G3-WF-1',version:'V0.2.11',planLocked:false,planHash:null,lockedAt:null,status:'new',phase:'plan',candidatePool:null,retrains:[],closed:[],open:[],result:null,simulationCount:0,lastCompletedMonth:null,lastError:null,createdAt:new Date().toISOString()}}
...
function report(){
 ...
 const L=['LINAS OPTI – G3 WALK-FORWARD LEARNER','Clean Core: V0.2.11','Handel: AVSTÄNGD','Plan låst: '+(x.planLocked?'JA':'NEJ')+' · '+(x.planHash||'—'),'',
