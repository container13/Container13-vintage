...
function report(){
 ...
 return ['LINAS OPTI – G2 REAL FORWARD / PAPER','Clean Core: V0.2.28','Kandidat: '+HASH,'Anchor: '+ANCHOR,'Handel: AVSTÄNGD','Regler: FRYSTA · ingen rescue/optimering','',
