...
function report(){
 ...
 return ['LINAS OPTI – G2 REAL FORWARD / PAPER','Clean Core: V0.2.7','Kandidat: '+HASH,'Anchor: '+ANCHOR,'Handel: AVSTÄNGD','Regler: FRYSTA · ingen rescue/optimering','',
...
function exportReport(){download(report(),`LINAS_OPTI_G2_REAL_FORWARD_V0207_${today()}.txt`)}
function exportRaw(){const x=load()||fresh();download(JSON.stringify(x,null,2),`LINAS_OPTI_G2_REAL_FORWARD_RAW_V0207_${today()}.json`,'application/json')}
