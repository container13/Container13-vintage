// ==UserScript==
// @name         Competence Tool – Android-mobilvy 2.0.6
...
/*
  ...
  /LeftContent/Show. På mobil bygger den äldre trädkontrollen inte sitt
...
(() => {
  ...
  const installMobileSignature = () => {
    ...
    signature.append(
      Object.assign(document.createElement('span'), { className: 'ctm-signature-title', textContent: 'Android-anpassad' }),
      product,
  ...
  const installDateRangeControls = () => {
    ...
    // Android/Firefox kan hamna i en omladdningsloop om datumintervallet
    // ändras automatiskt medan bemannings-iframe:n startar. Låt därför
    // serverns aktuella intervall vara orört vid sidstart. Knapparna ovan
    // anropar fortfarande applyRange() när användaren själv väljer − eller +.
    restoreVisibleDate();
    return true;
  };
