...
- Stor Ta foto-knapp direkt på Dashboard.
- Kamera och förhandsvisning för Nyinkommet.
- Ta om bild innan publicering.
- Ta nästa foto efter publicering.
- Ångra senaste uppladdningen till papperskorgen.
- Valbart snabbfotoläge i Inställningar.
- Dashboard visar dagens antal och senaste uppladdning.
