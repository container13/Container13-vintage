...
- Förhindrar att bildoptimeringen kan stå och vänta utan återkoppling.
- Visar varje steg från serverkontroll till färdig Firestore-sparning.
- Avbryter steg som tar för lång tid och visar den exakta orsaken.
- Låser upp verktyget efter ett misslyckat försök.
- Behåller den permanenta admincachekorrigeringen.
...
- Bildanimationen startar först när animationsbilden är färdigladdad.
- Om animationsbilden inte hinner laddas inom 0,8 sekunder hoppas animationen över för det besöket.
- Klassisk stjärna och guldstjärna behöver inte vänta på någon bild.
